<div class="direct-purchase">
  ...
  <a class="btn btn-blue-arrow pull-right" href="<?php print $url; ?>" style="margin-top: 5px; margin-right: 5px;" id="purchase-button-down"><span class="glyphicon glyphicon-cloud-download"></span> Direkt-Download <?php if($lizenz -> lizenz_download_filesize) { ?>(<?php print format_size($lizenz -> lizenz_download_filesize); ?>)<?php } ?></a>
