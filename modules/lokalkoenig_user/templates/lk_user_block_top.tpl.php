...
<form method="GET" id="kampasearch" action="<?php print url('suche'); ?>" class="formhover">
  ...
  <div class="showtext tooltip-inner" style="display: none; margin-top: 10px; text-align: left; position: absolute; z-index: 100; width: 400px; max-width: none; ">
      ...
      <div class="col-xs-2 text-center"><span style="font-size: 2.5em; margin-top: 15px; margin-left: 14px; color: #357ebd;" class="glyphicon glyphicon-info-sign"></span></div>
      <div class="col-xs-10">
      ...
      <p style="margin-top: 10px;">Geben Sie hier Suchbegriffe ein, wie z.B. Branchenbezeichnungen Bäcker, Fleischer, Auto, ...</p>
      <p style="margin-top: 10px;">Oder nutzen Sie die <strong>Stichwort Suche</strong> womit Sie gezielt in Branchen suchen können:</p>
