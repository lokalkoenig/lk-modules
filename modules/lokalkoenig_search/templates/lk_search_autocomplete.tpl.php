...
<div class="btn-group" style="margin-right: 10px;">
  <form method="GET" id="kampasearch" action="<?php print url('suche'); ?>" class="formhover">
    <input id="searchbegin" title="" title="Geben Sie hier Suchbegriffe ein, wie z.B. Branchenbezeichnungen Bäcker, Fleischer, Auto, ..." value="<?= $search_value; ?>" type="search" class="form-control form-text lk-autocomplete lk-autocomplete-search" placeholder="Kampagnensuche" name="search_api_views_fulltext" />
    <a href="<?php print url('suche'); ?>" onclick="jQuery('#kampasearch').submit(); return false;" class="btn btn-primary btn-suche" title="Kampagnen-Übersicht"><span class="glyphicon glyphicon-search"></span></a>
