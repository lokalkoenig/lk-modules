...
function lokalkoenig_addkampagne_contact_form($form, $form_state, $node){
  ...
  $form["text"] = array('#markup' => '<div class="well well-white">Haben Sie einen Fehler in der Kampagne entdeckt oder haben andere Anmerkungen dazu, dann schreiben Sie uns bitte eine persönliche Nachricht.</div>');
