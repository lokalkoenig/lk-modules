...
class InvestitionsUebersicht extends Preset {
  ...
  function getDefaultValues(){
    ...
    $sample_table = [
      0 => [
        '<p><strong>Bedarf des Kunden</strong></p>',
        '<p><strong>Merkmal unserer Leistung</strong></p>',
        '<p><strong>Nutzen des Kunden</strong></p>',
        '<p><strong>Mediawert</strong></p>',
        '<p><strong>Investition</strong></p>',
      ],
      1 => [
        '<p>Was braucht der Kunde?<br />Beispiel:</p>',
